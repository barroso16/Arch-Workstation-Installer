...
set_config_defaults() {
  ...
  INSTALL_DEV_PROFILE="${INSTALL_DEV_PROFILE:-${PROFILE_DEVELOPMENT:-yes}}"
  INSTALL_DESKTOP_PROFILE="${INSTALL_DESKTOP_PROFILE:-${PROFILE_DESKTOP:-yes}}"
  INSTALL_VIRT_PROFILE="${INSTALL_VIRT_PROFILE:-${PROFILE_VIRTUALIZATION:-yes}}"
  INSTALL_CONTAINERS_PROFILE="${INSTALL_CONTAINERS_PROFILE:-${PROFILE_CONTAINERS:-yes}}"
  INSTALL_AUDIT_PROFILE="${INSTALL_AUDIT_PROFILE:-${PROFILE_AUDIT:-yes}}"
  INSTALL_HARDENING_PROFILE="${INSTALL_HARDENING_PROFILE:-${PROFILE_HARDENING:-yes}}"
  INSTALL_SHELL_PROFILE="${INSTALL_SHELL_PROFILE:-${PROFILE_SHELL:-yes}}"
  INSTALL_EDITOR_PROFILE="${INSTALL_EDITOR_PROFILE:-${PROFILE_EDITOR:-yes}}"
  INSTALL_PRINTING_PROFILE="${INSTALL_PRINTING_PROFILE:-${PROFILE_PRINTING:-yes}}"
  INSTALL_BLUETOOTH_PROFILE="${INSTALL_BLUETOOTH_PROFILE:-${PROFILE_BLUETOOTH:-yes}}"
  INSTALL_MULTIMEDIA_PROFILE="${INSTALL_MULTIMEDIA_PROFILE:-${PROFILE_MULTIMEDIA:-yes}}"
...
validate_install_config() {
  ...
  validate_boolean_value "${INSTALL_PRINTING_PROFILE}" "INSTALL_PRINTING_PROFILE"
  validate_boolean_value "${INSTALL_BLUETOOTH_PROFILE}" "INSTALL_BLUETOOTH_PROFILE"
  validate_boolean_value "${INSTALL_MULTIMEDIA_PROFILE}" "INSTALL_MULTIMEDIA_PROFILE"
  ...
  validate_boolean_value "${INSTALL_AMD_IF_DETECTED}" "INSTALL_AMD_IF_DETECTED"
  ...
  validate_boolean_value "${ENABLE_SECURE_BOOT}" "ENABLE_SECURE_BOOT"
  ...
  case "${NVIDIA_DRIVER}" in
    auto|open-dkms|open) ;;
    *) die "NVIDIA_DRIVER no soportado: ${NVIDIA_DRIVER}" ;;
  esac
...
show_effective_config() {
  ...
  log_kv "Impresion" "${INSTALL_PRINTING_PROFILE}"
  log_kv "Bluetooth" "${INSTALL_BLUETOOTH_PROFILE}"
  log_kv "Multimedia" "${INSTALL_MULTIMEDIA_PROFILE}"
  ...
  log_kv "NVIDIA driver" "${NVIDIA_DRIVER}"
  log_kv "AMD auto" "${INSTALL_AMD_IF_DETECTED}"

  log_header "Secure Boot"
  log_kv "Secure Boot workflow" "${ENABLE_SECURE_BOOT}"
